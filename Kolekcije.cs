...
{
    internal static class Kolekcije
    {
        internal static List<Artikl> listaArtikala = new List<Artikl>();
        internal static List<Sto> listaStolova = new List<Sto>();
        internal static List<Racun> listaRacuna = new List<Racun>();
        internal static List<StavkaRacuna> listaStavki = new List<StavkaRacuna>();
